  ...
  <div id="reservation-page">
              ...
              <div class="overflow-x-auto custom-scrollbar">
                ...
                <div class="schedule-grid min-w-max" v-for="seat in currentSeatsPage" :key="seat">
                  ...
                  <button v-for="time in filteredTimeSlots" :key="`${seat}-${time}`"
                    @click="handleSlotClick(seat, time)" :class="getSlotClass(seat, time)"
    ...
    <div v-if="showDetailsModal" class="fixed inset-0 modal-overlay flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <div class="flex gap-3">
          <router-link :to="`/profile/${confirmData.user.user_id}`"
    ...
    <div v-if="showReservationDetailsModal" class="fixed inset-0 modal-overlay flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <div class="flex gap-3">
          <router-link :to="`/profile/${reservationDetails.user.user_id}`"
            class="flex-1 grablab-primary text-white py-3 rounded font-medium hover:opacity-90 text-center">
            View Profile
          </router-link>
