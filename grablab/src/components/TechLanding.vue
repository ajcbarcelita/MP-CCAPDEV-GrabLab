    ...
    <body class="min-h-screen flex flex-col">
      <div class="flex-1">
        ...
        <section id="hero-section">
          <h1 id="hero-title">Hi, Technician {{ currentUser.first_name }} {{ currentUser.last_name }} <br />Welcome back
            to GrabLab!</h1>
        ...
        <section class="max-w-8xl mx-auto mt-5 text-[#12372A] text-center flex flex-col items-center">
          <h2 class="text-6xl font-light mb-1 font-['Jomhuria'] text-[#12372A] py-2">Why Choose GrabLab?</h2>
            ...
            <div class="bg-[#FBFADA] p-6 rounded-xl shadow text-center border-2 border-[#12372A]">
              <div class="flex justify-center mb-3">
                <router-link to="/profile">
                  <img src="/src/assets/User-check.png" alt="View Current Availability" class="w-48 h-36" />
                </router-link>
              </div>
              <h3 class="font-bold text-xl mb-2">View current reservations</h3>
              <p class="text-[#12372A]">See your current lab room reservations at a glance</p>
            </div>
            <!-- Card 3 -->
            <div class="bg-[#FBFADA] p-6 rounded-xl shadow text-center border-2 border-[#12372A]">
              <div class="flex justify-center mb-3">
