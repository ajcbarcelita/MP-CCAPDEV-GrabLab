...
<template>
  <div class="bg-sage min-h-screen">
    ...
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden">
      ...
      <div class="absolute inset-0 bg-[url(@/assets/lab.png)] bg-center bg-cover blur-lg [mask-image:linear-gradient(180deg,green,rgba(0,255,0,0))] z-0"></div>
      ...
      <div class="relative z-10 container mx-auto px-4 py-8 max-w-4xl" v-if="profileUser">
        ...
        <div :class="isOwnProfile ? 'grid md:grid-cols-3 gap-8' : 'flex justify-center'">
          ...
          <div
            :class="isOwnProfile ? 'md:col-span-2 bg-cream rounded-lg shadow-lg p-6' : 'bg-cream rounded-lg shadow-lg p-6 w-full max-w-5xl'">
          ...
          <div v-if="isOwnProfile" class="align-middle space-y-12">
            ...
            <div v-if="showDeleteAccount" class="bg-pink-100 border-3 border-pink-200 rounded-lg p-6 text-center">
              ...
              <p class="text-pink-600 text-sm mb-4 font-karma">Permanently delete your account and all associated
                data.
