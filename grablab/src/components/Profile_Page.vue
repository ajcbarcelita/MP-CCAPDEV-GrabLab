		...
		<header class="bg-forest-dark text-cream">
			<div class="container mx-auto px-4 py-4 flex justify-between items-center">
				...
				<nav class="flex space-x-4 font-karma">
					<button
						@click="handleHome"
						class="hover:bg-forest-medium px-3 py-2 rounded transition-colors"
					>
						Home
					</button>
					<button
			...
			<div class="grid md:grid-cols-3 gap-8">
				...
				<div class="space-y-8">
					...
					<div class="bg-cream rounded-lg shadow-lg p-6">
						<h3 class="text-xl font-bold text-forest-dark mb-4 font-karma">
							Account Stats
						</h3>
						<div class="space-y-3">
							<div class="flex justify-between">
								<span class="text-forest-medium font-karma"
							...
							<div class="flex justify-between">
								<span class="text-forest-medium font-karma"
									>Active Reservations:</span
								>
								<span class="font-semibold text-forest-dark font-karma">2</span>
							</div>
							<div class="flex justify-between">
								<span class="text-forest-medium font-karma">Member Since:</span>
								<span class="font-semibold text-forest-dark font-karma"
									>June 2023</span
								>
							</div>
							<div class="flex justify-between">
					...
					<div
						...
						class="bg-pink-100 border-3 border-pink-200 rounded-lg p-6"
					>
