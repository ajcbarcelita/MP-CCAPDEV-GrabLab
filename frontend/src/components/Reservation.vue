...
<template>
  <div id="reservation-page">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div v-else>
              ...
              <div class="flex justify-center gap-4 mb-4 flex-wrap">
                <button @click="setTimeFilter('Morning')" :class="{
              ...
              <div class="overflow-x-auto custom-scrollbar">
                ...
                <div class="schedule-grid mb-2 min-w-max">
                  ...
                  <div v-for="timeSlot in filteredTimeSlots" :key="`${timeSlot.startTime}-${timeSlot.endTime}`"
                ...
                <div class="schedule-grid min-w-max" v-for="seat in currentSeatsPage" :key="seat">
                  ...
                  <button v-for="timeSlot in filteredTimeSlots" :key="`${seat}-${timeSlot.startTime}`"
                    @click="handleSlotClick(seat, timeSlot)" :class="getSlotClass(seat, timeSlot)"
    ...
    <div v-if="showReservationDetailsModal"
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6" @click.stop>
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="closeReservationDetailsModal" class="text-gray-400 hover:text-gray-600 transition-colors">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="max-h-48 overflow-y-auto border rounded-lg">
              <div class="divide-y">
                <div v-for="(slot, index) in reservationDetails.slots" :key="`${slot.seat}-${slot.timeSlot.startTime}`"
          ...
          <div class="flex gap-3 pt-4 border-t">
            <button v-if="canCancelReservation(reservationDetails.reservation_id)"
    ...
    <div v-if="showCancelConfirmationModal"
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4 max-h-[80vh] flex flex-col" @click.stop>
        ...
        <div class="flex justify-between items-center p-6 border-b">
          ...
          <button @click="closeCancelConfirmationModal" class="text-gray-400 hover:text-gray-600 transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
            </svg>
          </button>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="max-h-64 overflow-y-auto border rounded-lg">
                <div class="divide-y">
                  <div v-for="(slot, index) in reservationDetails.slots"
                    :key="`${slot.seat}-${slot.timeSlot.startTime}`" class="p-3 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                      <div class="flex items-center space-x-3">
